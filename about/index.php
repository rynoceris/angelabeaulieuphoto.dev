	...
	<div id="content">
		<div id="sub-content">
			<div id="copy">
				...
				<p>Please use the navigation below to see my galleries, pricing, blog, and most importantly contact me if you would like to schedule a photo shoot!</p>
			</div>
			<div id="sidebar">
				<img src="../images/about-angela.jpg" alt="" />
			</div>
		</div>
		<?php require('../nav.php') ?>
	</div>
